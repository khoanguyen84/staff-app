            ...
            <section className="staff-info my-3">
                <div className="container">
                    <div className="d-flex align-items-center">
                        <h4>Staff Manager</h4> <button className="btn btn-primary btn-sm ms-2"><i className="fa fa-plus-circle me-1"></i>New</button>
                    </div>
                    ...
                    <div className="d-flex align-items-center">
                        <input type="search" className="form-control w-25 me-2" placeholder="Search staff name" />
                                                ...
                                                <div className="row align-items-center">
                                                    ...
                                                    <div className="col-1">
                                                        <div className="d-flex flex-column align-items-center">
                                                            ...
                                                            <Link to={"/staff/edit"} className="btn btn-primary btn-sm mb-1"><i className="fa fa-edit"></i></Link>
